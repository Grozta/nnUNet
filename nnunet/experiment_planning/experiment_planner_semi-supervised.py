...
class ExperimentPlanner3D_semi_supervised(ExperimentPlanner):
    """
    ...
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        super(ExperimentPlanner3D_semi_supervised, self).__init__(folder_with_cropped_data, preprocessed_output_folder)
        self.data_identifier = "nnUNetData_plans_semi_supervised"
        self.plans_fname = join(self.preprocessed_output_folder,
                                "nnUNetData_plans_semi_supervised_plans_3D.pkl")
